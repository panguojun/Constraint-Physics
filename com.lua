...
----------------------------
_phase_ops={}
function PHASE(angle)
	local tb={angle = angle}
	setmetatable(tb, _phase_ops)
	return tb
end
_phase_ops.__add=function(c)
	return PHASE(self.angle + c.angle)
end
_phase_ops.__mul=function(c, p)
	return p * math.cos(c.angle * math.pi / 180)
end
----------------------------
--			File
----------------------------
